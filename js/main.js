...
var idbApp = (function() {
  ...
  if (!('indexedDB' in window)) { //Jika tidak ada indexedDB di browser
    console.log('This browser doesn\'t support IndexedDB'); //Buat pesan error di konsol
    return; //Tampilkan
  }

  var dbPromise = idb.open('couches-n-things', 5, function(upgradeDb) { //pemberian nama db
    switch (upgradeDb.oldVersion) { //case untuk memperbarui db
      case 0:
